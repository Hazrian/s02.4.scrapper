...
def get_townhall_email(townhall_url)
  puts a = Nokogiri::HTML(open(townhall_url)).xpath("/html/body/div/main/section[2]/div/table/tbody/tr[4]/td[2]").text
  return a
end

def get_townhall_email_array
  puts get_townhall_urls.map{ |key, value| get_townhall_urls[key] = get_townhall_email("https://annuaire-des-mairies.com#{value}")}
